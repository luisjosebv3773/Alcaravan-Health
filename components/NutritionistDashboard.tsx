                        ...
                        <div className="xl:col-span-8 flex flex-col gap-8">
                            ...
                            <div className="bg-surface-light dark:bg-surface-dark rounded-2xl p-6 border border-gray-200 dark:border-gray-800 shadow-sm">
                                <div className="flex items-center gap-3 mb-6">
                                    ...
                                    <h3 className="text-lg font-bold text-gray-900 dark:text-white">Simulador de Estrategia Nutricional</h3>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="bg-gray-50 dark:bg-black/20 rounded-xl p-5 border border-gray-200 dark:border-gray-700">
                                        <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-4">Meta de Macronutrientes</h4>
                                        <div className="flex items-center gap-6">
                                            <div className="size-32 shrink-0 relative shadow-lg rounded-full" style={{ background: 'conic-gradient(#13ec5b 0% 50%, #3b82f6 50% 75%, #fbbf24 75% 100%)' }}>
                                                <div className="absolute inset-0 m-[20%] bg-surface-light dark:bg-surface-dark rounded-full flex items-center justify-center">
                                                    <span className="text-xs font-bold text-gray-500">Diario</span>
                                                </div>
                                            </div>
                                            <div className="flex-1 space-y-2">
                                                <MacroItem color="bg-primary" label="Carbohidratos" percentage="50%" />
                                                <MacroItem color="bg-blue-500" label="Proteínas" percentage="25%" />
                                                <MacroItem color="bg-yellow-400" label="Grasas" percentage="25%" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="space-y-4">
                                        <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Calculadora de Peso Meta</h4>
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                <label className="block text-xs font-medium text-gray-500 mb-1">Estatura (cm)</label>
                                                <input className="w-full rounded-lg border-gray-200 dark:border-gray-600 bg-white dark:bg-surface-dark text-sm" type="number" defaultValue="178" />
                                            </div>
                                            <div>
                                                <label className="block text-xs font-medium text-gray-500 mb-1">IMC Objetivo</label>
                                                <input className="w-full rounded-lg border-gray-200 dark:border-gray-600 bg-white dark:bg-surface-dark text-sm" type="number" defaultValue="23.5" />
                                            </div>
                                        </div>
                                        <div className="p-3 bg-primary/10 rounded-lg border border-primary/20 flex items-center justify-between">
                                            <span className="text-sm text-emerald-900 dark:text-emerald-100 font-medium">Peso Ideal:</span>
                                            <span className="text-xl font-bold text-primary">74.5 kg</span>
                                        </div>
                                        <button className="w-full py-2 bg-surface-dark dark:bg-white text-white dark:text-black rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity">
                                            Actualizar Plan
                                        </button>
                                    </div>
                                </div>
